...
// Items data
const items = [
    { name: 'Big Mac', cost: 2, imgSrc: './assets/img/items-pics/big-mac.jpg' },
    { name: 'Flip Flops', cost: 3, imgSrc: './assets/img/items-pics/flip-flops.jpg' },
    { name: 'Coca-Cola Pack', cost: 5, imgSrc: './assets/img/items-pics/coca-cola-pack.jpg' },
    { name: 'Movie Ticket', cost: 12, imgSrc: './assets/img/items-pics/movie-ticket.jpg' },
    { name: 'Book', cost: 15, imgSrc: './assets/img/items-pics/book.jpg' },
    { name: 'Lobster Dinner', cost: 45, imgSrc: './assets/img/items-pics/lobster-dinner.jpg' },
    { name: 'Video Game', cost: 60, imgSrc: './assets/img/items-pics/video-game.jpg' },
    { name: 'Amazon Echo', cost: 99, imgSrc: './assets/img/items-pics/amazon-echo.jpg' },
    { name: 'Year of Netflix', cost: 100, imgSrc: './assets/img/items-pics/year-of-netflix.jpg' },
    { name: 'Air Jordans', cost: 125, imgSrc: './assets/img/items-pics/air-jordans.jpg' },
    { name: 'Airpods', cost: 199, imgSrc: './assets/img/items-pics/airpods.jpg' },
    { name: 'Gaming Console', cost: 299, imgSrc: './assets/img/items-pics/gaming-console.jpg' },
    { name: 'Drone', cost: 350, imgSrc: './assets/img/items-pics/drone.jpg' },
